...
* 现在看从前的代码感觉不是很科学（组件和view部分），觉得应该重构。redux?一般redux用来解决跨组件通信或者说高交互问题，看看合适不合适。

* 这个没完好吧，加载速度越快越好。emmm，其中有一次cdn不好使了，还是引本地的资源文件吧，如果用provideplugin还是得把包带进bundle里面。。。。没用cdn没法用全局，包又大了10几k
